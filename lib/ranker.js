...
class Ranker {
  ...
  async getRanking(options) {
    ...
    const dancers = await getDancers(query, options.startDate, options.endDate, options.participants, options.homeAway, options.tpfServer, options.removeFemaleDancers);
